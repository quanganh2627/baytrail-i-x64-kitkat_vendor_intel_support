...
make_kernel() {
    ...
    case "${custom_board}" in
    mfld_cdk | mfld_pr2 | mfld_gi | ctp_pr0)
...
usage() {
    ...
    echo ""
    echo " -c [generic_x86|vbox|mfld_cdk|mfld_pr2|mfld_gi|ctp_pr0]"
...
main() {
    local custom_board_list="vbox mfld_cdk mfld_pr2 mfld_gi ctp_pr0"
