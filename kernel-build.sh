...
init_variables() {
    ...
    generic_x86 | vbox )
        ...
        _soc_type="vbox"
        ;;
    mfld_cdk | mfld_pr2 | mfld_gi | mfld_dv10 | salitpa | mfld_tablet_evx)
        VENDOR=intel
        BOARD=${custom_board}
       _soc_type="mfld"
        ;;
...
set +x
    ...
    case "${custom_board}" in
    mfld_cdk | mfld_pr2 | mfld_gi | mfld_dv10 | salitpa | mfld_tablet_evx | ctp_pr0 | ctp_pr1 | ctp_nomodem | mrfl_vp | mrfl_hvp | mrfl_sle)
...
usage() {
    ...
    echo ""
    echo " -c [generic_x86|vbox|mfld_cdk|mfld_pr2|mfld_gi|mfld_dv10|salitpa|mfld_tablet_evx|ctp_pr0|ctp_pr1|ctp_nomodem|mrfl_vp|mrfl_hvp|mrfl_sle]"
...
main() {
    local custom_board_list="vbox mfld_cdk mfld_pr2 mfld_gi mfld_dv10 salitpa mfld_tablet_evx ctp_pr0 ctp_pr1 ctp_nomodem mrfl_vp mrfl_hvp mrfl_sle"
